...
exports.GetCash = void 0;
var Request_lib_1 = require("./Request.lib");
function GetCash(symbol) {
    return __awaiter(this, void 0, void 0, function () {
        var CashFlows, $, _loop_1, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    CashFlows = [];
                    return [4 /*yield*/, Request_lib_1.Request("https://finance.yahoo.com/quote/" + symbol + "/cash-flow")];
                case 1:
                    $ = _a.sent();
                    _loop_1 = function (i) {
                        var CashFlow = {
                    ...
                    return [2 /*return*/, CashFlows];
            }
        });
    });
}
exports.GetCash = GetCash;
//# sourceMappingURL=Cash.lib.js.map