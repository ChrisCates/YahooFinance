...
exports.GetInsiderTransactions = void 0;
var Request_lib_1 = require("./Request.lib");
function GetInsiderTransactions(symbol) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Request_lib_1.Request("https://finance.yahoo.com/quote/" + symbol + "/insider-transactions")];
                case 1:
                    $ = _a.sent();
                    $('table[data-test="insider-purchases"] tbody tr').each(function (i, e) {
                        var OverviewItem = {
                    ...
                    $('table[class="W(100%) BdB Bdc($seperatorColor)"] tbody tr').each(function (i, e) {
                        var InsiderTransaction = {
                    ...
                    return [2 /*return*/, InsiderTransactions];
            }
        });
    });
}
exports.GetInsiderTransactions = GetInsiderTransactions;
//# sourceMappingURL=InsiderTransactions.lib.js.map