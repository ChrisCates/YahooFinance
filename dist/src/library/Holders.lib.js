...
exports.GetHolders = void 0;
var Request_lib_1 = require("./Request.lib");
function GetHolders(symbol) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Request_lib_1.Request("https://finance.yahoo.com/quote/" + symbol + "/holders")];
                case 1:
                    $ = _a.sent();
                    $('div[data-test="holder-summary"] table tbody tr').each(function (i, e) {
                        var text = $(e).find('td:nth-child(1)').text();
                        switch (i) {
                            case 0:
                    ...
                    $('div[class="Mt(25px) Ovx(a) W(100%)"] table tbody tr').each(function (i, e) {
                        var Holder = {
...
//# sourceMappingURL=Holders.lib.js.map